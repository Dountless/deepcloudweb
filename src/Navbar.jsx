...
function Navbar() {
  ...
  <div className="container-fluid ">
    <NavLink    className=" navbar-brand" to="/">DeepCloud</NavLink>
    <button activeClassName="menu_active" className=" navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span activeClassName="menu_active" className=" navbar-toggler-icon"></span>
     </button> 
